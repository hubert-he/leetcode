...
** 需要注意的是，在某些语言（如 Java）中，没有无符号整数类型，因此对 num 的右移操作应使用逻辑右移
 */
const (
	m1 = 0x55555555		// 5 = 0101...   m1 << 1 为 1010...
	m2 = 0x33333333		// 3 = 0011...   m2 << 2 为 1100...
	m4 = 0x0F0F0F0F		// F = 1111
	m8 = 0x00FF00FF		//
	m16 = 0x0000FFFF
)
// 分治，自底向上
...
// 时间复杂度 O(logn)
func reverseBits2(n uint32) (rev uint32) {
	for i := 0; i < 32 && n > 0; i++ {
		rev |= n & 1 << (31 - i)
		n >>= 1
	}
